...
<div class="gallery-grid">
  {{< glightbox-figure src="mandala_01.png" title="Neural Fireworks" alt="A saturated mandala of branching red, blue and green filament lines with a yellow sunburst centre, resembling a neural network or fractal crystal lattice" >}}
  {{< glightbox-figure src="cover.png" title="Yellow Supernova" alt="A vivid mandala with yellow radial lines bursting from a blue core, concentric rings of pink and green spirals, and a magenta floral outer border on dark purple" >}}
  {{< glightbox-figure src="mandala_03.png" title="Pastel Bloom" alt="A pastel mandala with lavender, pink, mint and sky-blue calligraphic strokes radiating from a cyan-green centre, framed by a scalloped floral border" >}}
</div>
